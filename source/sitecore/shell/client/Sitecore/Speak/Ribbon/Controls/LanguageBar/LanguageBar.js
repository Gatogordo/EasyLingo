...
function (Sitecore, RibbonPageCode, ExperienceEditor) {
  Sitecore.Factories.createBaseComponent({
    ...
    initialize: function () {
      ...
      ExperienceEditor.Common.registerDocumentStyles(["/-/speak/v1/ribbon/LanguageBar.css"], ExperienceEditor.getPageEditingWindow().document);
    },
    ...
    changeLanguage: function (language) {
		...
		ExperienceEditor.PipelinesUtil.generateRequestProcessor("ExperienceEditor.Language.ChangeLanguage", function (response) {
			...
			ExperienceEditor.getPageEditingWindow().location = newLanguageUrl + "?sc_mode=edit";
		}).execute(context);
	},
  });
});